      ...
      <div className="p-8 space-y-4">
        <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/60">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Master Access</span>
            <span className="text-[9px] font-bold text-cyan-400">UNLIMITED</span>
          </div>
